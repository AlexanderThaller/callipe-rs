...
impl Pinger {
    async fn run(self) -> Result<Registry, String> {
        ...
        register_int_gauge_with_registry!("ping_failed_status", "if the probe failed", registry)
            .unwrap()
